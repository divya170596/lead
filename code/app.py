...
encoder_pickle_path = 'model\encoder1.pkl'
...
def lead_table():
    ...
    if request.method == 'POST':
        ...
        # Load the dataset
        data_path = 'data\salesforce_data.csv'
    ...
    try:
        ...
        #     'Industry':'Government',
        #     'RevenueRange':'4M - 6M',  
        #     'Technology__c':'Healthcare',
        #     'Technology_Service__c':'Healthcare Data Management'# Filter for 'Hot Lead' category
        # }
